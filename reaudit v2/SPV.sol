...
contract SPV is Ownable {
    ...
    event ValueUpdated( uint indexed total );
    ...
    mapping( address => bool ) public canAudit;
    ...
    function toggleAuditor( address _auditor ) external onlyOwner() {
        canAudit[ _auditor ] = !canAudit[ _auditor ];
    }
    ...
    function auditTotalValue() external {
        require( canAudit[ msg.sender ], "You cannot audit" );
        updateTotalValue();
    }
