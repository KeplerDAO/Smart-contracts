...
contract Treasury is Ownable {
    ...
    // Total 5 arguments. 3rd argument is `address _Frax`, 4th argument is `address _KEEPERDAI`
    constructor (address _KEEPER, address _DAI, uint _secondsNeededForQueue) {
